...
<script type="text/javascript">
  var role_user = '{{$roles}}';
   ...
   <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2> Persuratan Kedai Computerworks</h2>
                    ...
                    <div class="" role="tabpanel" data-example-id="togglable-tabs">
                      ...
                      <div id="myTabContent" class="tab-content">
                        <div role="tabpanel" class="tab-pane fade active in" id="tab_content1" aria-labelledby="home-tab">
                          <table id="table_surat_masuk" class="table table-striped table-bordered">
			                <thead>
			                  <tr>
                          <th>No. </th>
			                    <th>Judul surat</th>
                        ...
                        <div role="tabpanel" class="tab-pane fade active" id="tab_content2" aria-labelledby="profile-tab">
                         <table id="table_surat_keluar" class="table table-striped table-bordered">
			                <thead>
			                  <tr>
                          <th>No. </th>
			                    <th>Judul surat</th>
...
<div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title">Tambah Data Persuratan</h4>
    </div>
